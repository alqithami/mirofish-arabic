...
from ..utils.locale import get_interview_prompt_prefix, get_request_locale

logger = get_logger('mirofish.api.simulation')

ZepEntityReader = lazy_symbol('app.services.zep_entity_reader', 'ZepEntityReader')
OasisProfileGenerator = lazy_symbol('app.services.oasis_profile_generator', 'OasisProfileGenerator')
SimulationManager = lazy_symbol('app.services.simulation_manager', 'SimulationManager')
SimulationStatus = lazy_symbol('app.services.simulation_manager', 'SimulationStatus')
SimulationRunner = lazy_symbol('app.services.simulation_runner', 'SimulationRunner')
RunnerStatus = lazy_symbol('app.services.simulation_runner', 'RunnerStatus')
...
def optimize_interview_prompt(prompt: str, locale: str = "en") -> str:
    ...
    prompt_prefix = get_interview_prompt_prefix(locale)
...
def generate_profiles():
    ...
    try:
        ...
        generator = OasisProfileGenerator(locale=get_request_locale())
...
def interview_agents_batch():
    ...
    try:
        ...
        for interview in interviews:
            ...
            optimized_interview['prompt'] = optimize_interview_prompt(interview.get('prompt', ''), locale=get_request_locale())
