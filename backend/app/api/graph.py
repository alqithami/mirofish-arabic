...
OntologyGenerator = lazy_symbol('app.services.ontology_generator', 'OntologyGenerator')
GraphBuilderService = lazy_symbol('app.services.graph_builder', 'GraphBuilderService')
TextProcessor = lazy_symbol('app.services.text_processor', 'TextProcessor')
