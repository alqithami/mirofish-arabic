      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ t('step1.buildCompleted') }}</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          ...
          <p class="description">{{ t('step1.completeDescription') }}</p>
          <button 
            class="action-btn" 
...
const handleEnterEnvSetup = async () => {
  ...
  try {
    ...
    if (res.success && res.data?.simulation_id) {
      ...
      alert(`${t('step1.createSimulationFailed')}: ${res.error || t('graph.unknown')}`)
    }
  } catch (err) {
