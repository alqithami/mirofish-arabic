          ...
          <div v-else class="detail-content">
            ...
            <template v-if="selectedItem.data.isSelfLoopGroup">
              <div class="edge-relation-header self-loop-header">
                ...
                <span class="self-loop-count">{{ t('graph.items', { count: selectedItem.data.selfLoopCount }) }}</span>
              </div>
              ...
              <div class="self-loop-list">
                ...
                >
                  ...
                  >
                    ...
                    <span class="self-loop-name">{{ loop.name || loop.fact_type || t('graph.relatedTo') }}</span>
