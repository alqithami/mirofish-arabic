        ...
        <div class="card-header">
          ...
          <div class="card-status-icons">
            <span 
              ...
              :title="t('history.status.graphBuild')"
            >◇</span>
            <span 
              class="status-icon available" 
              :title="t('history.status.environmentSetup')"
            >◈</span>
            <span 
              class="status-icon" 
        ...
        <div class="card-files-wrapper">
          ...
          <div class="files-list" v-if="project.files && project.files.length > 0">
            ...
            <div v-if="project.files.length > 3" class="files-more">
              {{ t('history.filesMore', { count: project.files.length - 3 }) }}
            </div>
          </div>
          <!-- 无文件时的占位 -->
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="modal-section">
                ...
                <div class="modal-requirement">{{ selectedProject.simulation_requirement || t('history.noValue') }}</div>
              </div>
            ...
            <div class="modal-actions">
              ...
              >
                ...
                <span class="btn-text">{{ t('common.steps.graphBuild') }}</span>
              </button>
              <button 
              ...
              >
                ...
                <span class="btn-icon">◈</span>
                <span class="btn-text">{{ t('common.steps.environmentSetup') }}</span>
              </button>
              <button 
              ...
              >
                ...
                <span class="btn-icon">◆</span>
                <span class="btn-text">{{ t('common.steps.reportGeneration') }}</span>
              </button>
            </div>
            <!-- 不可回放提示 -->
